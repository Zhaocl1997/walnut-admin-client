<template>
  <div class="flex items-center">
    <flip-item :total="2" :current="getTimeArr[0]" />
    <flip-item :total="9" :current="getTimeArr[1]" />
    ...
    <flip-item :total="5" :current="getTimeArr[2]" />
    <flip-item :total="9" :current="getTimeArr[3]" />
    ...
    <template v-if="!addAdapter.isMobile">
      ...
      <flip-item :total="5" :current="getTimeArr[4]" />
      <flip-item :total="9" :current="getTimeArr[5]" />
    </template>
  </div>
</template>

      ...
      <n-spin :show="loading">
        <div class="relative" :style="`height: ${canvasHeight}px`">
          ...
          <canvas
            ...
            :style="getCanvasBaseStyle"
            :class="[
              'absolute top-0 left-0 opacity-0 transition-opacity duration-700 z-30',
          ...
          <div
            :class="[
              'absolute bottom-0 left-0 w-full h-6 text-center opacity-0 transition-all z-50 bg-green-600',
          ...
          >
            <w-icon icon="carbon:reset" height="36"></w-icon>
          </n-button>
        </div>
      </n-spin>

<template>
  <w-demo-card title="Basic Title">
    <n-space size="small" vertical>
      ...
      <w-title prefix="bar">This is a title with state.</w-title>
      <w-title prefix="bar" type="info">This is a title with state.</w-title>
      <w-title prefix="bar" type="error">This is a title with state.</w-title>
      <w-title prefix="bar" type="warning">This is a title with state.</w-title>
    </n-space>
  </w-demo-card>
</template>

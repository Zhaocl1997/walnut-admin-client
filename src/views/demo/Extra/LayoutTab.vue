<template>
  <w-demo-card title="Demo for layout tab">
    <n-list>
      <n-list-item>
        <w-title prefix="bar"> Basic create: {{ index }} </w-title>
      ...
      <n-list-item>
        <w-title prefix="bar"> Dynamic Title </w-title>

        <n-button @click="onDynamicTitle(1)">Set title(default 5s)</n-button>
        <n-button @click="onDynamicTitle(2)"
          >Set title with timeout limit(3s)</n-button
        >
        <n-button @click="onDynamicTitle(3)"
          >Set title with scrolling for 10s</n-button
        >
        <n-button @click="onDynamicTitle(4)">Recovery</n-button>
      </n-list-item>
      ...
      <n-list-item>
        <w-title prefix="bar"> Dynamic Icon </w-title>

        <n-button @click="onDynamicIcon(1)">Set Icon(default 5s)</n-button>
        <n-button @click="onDynamicIcon(2)"
          >Set icon with timeout limit(3s)</n-button
        >
        <n-button @click="onDynamicIcon(3)">Set icon with animate</n-button>
        <n-button @click="onDynamicIcon(4)">Recovery</n-button>
      </n-list-item>
      ...
      <n-list-item>
        ...
        <n-button
          ...
          >Set icon with animate</n-button
        >
        <n-button
          :disabled="getOtherTabButtonDisabled"
      ...
      <n-list-item>
        <w-title prefix="bar"> Dynamic Query/Params (WIP) </w-title>

...
<template>
  <w-demo-card title="Highly packaged ali oss use demo">
    <n-list>
      <n-list-item>
        <w-demo-card title="Basic Usage">
          <w-JSON :value="state.fileList1" />

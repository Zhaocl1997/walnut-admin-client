<template>
  <div>
    ...
    <n-button @click="onClick(1)">string/number</n-button>
    <n-button @click="onClick(2)">object</n-button>
    <n-button @click="onClick(3)">array</n-button>
  ...
  const onClick = async (type: number) => {
    ...
    if (type === 2) {
      await AppRouter.replace({
        query: { b: { b1: '123', b2: 321, b3: false } },
      })
    }
